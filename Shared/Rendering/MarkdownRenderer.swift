...
public struct MarkdownRenderer: Sendable {
    ...
    // Heading extraction & TOC generation extension (issue #12/#21) lives in
    // MarkdownRenderer+TOC.swift, split out to keep this file under swiftlint's
    // file/type length limits -- see that file for `extractHeadingsAndAssignIDs`.
}
